...
Call log:
  - waiting for getByRole('row').filter({ hasText: '575083' }).filter({ hasText: 'flib jon' }).filter({ hasText: 'flipejone@gmail.com' }).locator('td:nth-child(9)')
    ...
    at agentsPage.toggleUser (C:\Users\derej\Desktop\Connect\pages\bankPortal\maker\agents.page.js:146:33)
