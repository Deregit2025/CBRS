...
Call log:
  - waiting for getByRole('textbox', { name: 'Email' })
    ...
    at loginChecker (C:\Users\derej\Desktop\Connect\pages\bankPortal\checker\login.page.js:10:54)
...
> 10 |   await page.getByRole('textbox', { name: 'Email' }).fill('cbenewchecker@gmail.com');
     |                                                      ^ Error: locator.fill: Test timeout of 30000ms exceeded.
