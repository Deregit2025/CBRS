...
Call log:
  - waiting for locator('button[aria-haspopup="listbox"]')
    - locator resolved to <button type="button" aria-expanded="false" aria-haspopup="listbox" data-headlessui-state="" id="headlessui-listbox-button-:r3:" class="rizzui-select-button flex items-center peer hover:border-primary w-full transition duration-200 ring-[0.6px] hover:ring-primary focus:border-primary focus:ring-primary border-0 ring-muted/70 hover:ring-[1.8px] focus:ring-[1.8px] hover:bg-transparent focus:bg-transparent bg-muted/70 backdrop-blur px-3 py-2 text-sm h-10 rounded-md pe-2.5">…</button>
...
```ts
   ...
   6 |         this.pageSizeButton = page.locator('button[aria-haspopup="listbox"]');
