...
Received string: "          450574testagent encrtest@gmail.com+251910101010EthiopiaaddisTue, May 20 2025 (8:55 AM)EnabledCurrently enabled - click to disable"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('tbody')
    3 × locator resolved to <tbody class="rc-table-tbody">…</tbody>
