...
Call log:
  - waiting for getByRole('textbox', { name: 'Email' })
    ...
    at login (C:\Users\derej\Desktop\Connect\pages\bankPortal\maker\login.page.js:10:54)
      ...
      - row "#2357-LLKU Loan Product UPDATE_INTEREST cbenewmaker cbenewbank Jun 19 2025 PENDING":
        ...
        - cell:
          - link:
            ...
            - button:
              - img
      - row "#7582-TL38 Loan Product UPDATE_INTEREST cbenewmaker cbenewbank Jun 19 2025 APPROVED":
        - cell "#7582-TL38":
          - paragraph: "#7582-TL38"
        - cell "Loan Product":
          - paragraph: Loan Product
        ...
        - cell:
          - link:
            - /url: /action/detail/e223232d-062f-40ef-864f-5ad926d1c006?action=LOAN_PRODUCT
            - button:
              - img
  - text: "Rows per page:"
  - button "10":
    ...
    - img
  - list:
    - listitem: Showing 1-10 of 201 items
