...
Call log:
  - waiting for locator('tbody tr') to be visible
    26 × locator resolved to 11 elements. Proceeding with the first one: <tr aria-hidden="true" class="rc-table-measure-row">…</tr>

    at agentsPage.toggleUserByEmail (C:\Users\derej\Desktop\Connect\pages\bankPortal\maker\agents.page.js:133:21)
...
> 133 |     await this.page.waitForSelector("tbody tr", { state: "visible", timeout: 15000 });
      |                     ^ TimeoutError: page.waitForSelector: Timeout 15000ms exceeded.
  134 |
  135 |     const toggleButtonCell = this.toggleButtonCellByEmail(email);
  136 |     await toggleButtonCell.waitFor({ state: "visible", timeout: 10000 });
  137 |
  138 |     await toggleButtonCell.click();
  139 |     await this.confirmButton.click();
  140 |     await this.page.waitForTimeout(1000);
  141 |
  142 |     await toggleButtonCell.click();
